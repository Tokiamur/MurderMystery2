...
credits.Size = UDim2.new(0, 220, 0, 12)
credits.Position = UDim2.new(0, 66, 0, 54)
credits.BackgroundTransparency = 1
credits.Text = "made by Mentoz / Tokiamur"
...
closeBtn.MouseEnter:Connect(function()
    tween(closeBtn, 0.15, {BackgroundTransparency = 0, Size = UDim2.new(0, 32, 0, 32), Position = UDim2.new(1, -45, 0.5, -16)}):Play()
    tween(closeBtnStroke, 0.15, {Transparency = 0}):Play()
end)
closeBtn.MouseLeave:Connect(function()
    tween(closeBtn, 0.15, {BackgroundTransparency = 0.2, Size = UDim2.new(0, 30, 0, 30), Position = UDim2.new(1, -44, 0.5, -15)}):Play()
...
local function getItemTypeLabel(name)
...
local function openGUI()
    ...
    mainFrame.Position = UDim2.new(0.5, -180, 0.5, 0)
    outerGlow.Position = UDim2.new(0.5, -202, 0.5, -267)
    outerGlow.BackgroundTransparency = 1
    tween(mainFrame, 0.5, {Size = UDim2.new(0,360,0,490), Position = UDim2.new(0.5,-180,0.5,-245)}, Enum.EasingStyle.Back):Play()
    tween(outerGlow, 0.6, {BackgroundTransparency = 0.92}):Play()
end

local function closeGUI()
    isOpen = false
    tween(mainFrame, 0.3, {Size = UDim2.new(0,360,0,0), Position = UDim2.new(0.5,-180,0.5,0)}, Enum.EasingStyle.Back, Enum.EasingDirection.In):Play()
...
-- ═══════════════════════════════════════
--    ФОНОВЫЕ АНИМАЦИИ ОСНОВНОГО GUI
-- ═══════════════════════════════════════
task.spawn(function()
    local t = 0
    while screenGui.Parent do
